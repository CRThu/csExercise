...
namespace ClassMember
{
    class MyClass
    {
        ...
        public override string ToString() => "Override : " + base.ToString();   // 重写Object类ToString
        public virtual void DoString()  // 基类, 方法可以重写
        {
            // Base implementation.
        }
        // 定义属性
    ...
    class MyDerivedClass : MyClass  // override和new区别详见MyBaseClassAndMyDerivedClass.cs
    {
